...
export default class SnakSlots extends Component{
 ...
 render(){
   console.log("restcash  "+ this.state.restCash)
    console.log(this.props.enteredKey,this.props)
     return(
    <div className="snakSlot">
      <div className="container">
        {this.state.snaksItems.map((item,i) =>
          ...
          <button onClick={()=>this.props.subOrder({selectedSnak:this.state.snaksItems[this.props.enteredKey-1]})}>subOrder</button>
